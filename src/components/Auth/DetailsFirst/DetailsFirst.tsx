...
import { setDetailsFirst } from '../../../store/actions/detailsActions';
import { setEcomercePlatform } from '../../../store/actions/eCommercePlatformAction';
...
const DetailsFirst: React.FC<DetailsFirstProps> = ({ handleStep }) => {
  ...
  const onSubmitHandle = handleSubmit((data: IDetailsFirst): void => {
    ...
    dispatch(setDetailsFirst({ ...data, partnerKey }));
